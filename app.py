...
def generate_parent_message(student_name, score, is_absent):
    if is_absent:
        ...
        return f"المكرم ولي أمر الطالب السلام عليكم ورحمة الله وبركاته/ {student_name}، 
يسعدنا إبلاغكم بأن ابنكم قدم أداءً تحصيلياً متميزاً وسلوكاً رائعاً داخل الفصل، وحصل على درجات ممتازة في التقييمات الأخيرة.نشكر لكم حسن المتابعة والاهتمام، ونرجو الاستمرار في هذا الدعم المتبادل للحفاظ على هذا المستوى المتفوق.مع تحياتنا
 ({score}%)، مع أطيب دعواتنا له بالتوفيق والاستمرارية."
