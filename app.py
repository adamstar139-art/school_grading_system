...
def send_mora_sms(phone, message, username="966560229124", password="THA@0508634881", sender_name="S", otp_code=""):
    """
...
def send_mora_bulk_sms(students_list, username="966560229124", password="THA@0508634881", sender_name="S", otp_code=""):
    """
...
mora_user = st.sidebar.text_input("اسم المستخدم / الرقم:", value="966560229124", key="mora_u")
mora_pass = st.sidebar.text_input("كلمة المرور:", value="THA@0508634881", type="password", key="mora_p")
mora_sender = st.sidebar.text_input("اسم المرسل المعتمد:", value="S", key="mora_s")
